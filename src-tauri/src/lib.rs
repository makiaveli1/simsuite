...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::detect_game_installation_candidates,
            ...
            commands::record_apply_plan_result_log,
            commands::list_apply_plan_result_logs,
            commands::record_apply_plan_restore_entry,
            commands::list_apply_plan_restore_entries,
            ...
            commands::ignore_download_items,
