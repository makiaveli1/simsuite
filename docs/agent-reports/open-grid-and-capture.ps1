...
# Step 1: click Library in sidebar
Click-At ($rect.Left + 54) ($rect.Top + 382)
Start-Sleep -Seconds 2

# Step 2: click grid toggle (measured from live DOM)
Click-At ($rect.Left + 774) ($rect.Top + 143)
Start-Sleep -Seconds 3

$bmp = New-Object System.Drawing.Bitmap($width, $height)
$graphics = [System.Drawing.Graphics]::FromImage($bmp)
$graphics.CopyFromScreen($rect.Left, $rect.Top, 0, 0, $bmp.Size)
$out = 'C:\Users\likwi\OneDrive\Desktop\PROJS\SimSort\docs\agent-reports\phase3-windows-grid.png'
