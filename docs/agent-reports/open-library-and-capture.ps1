...
# Playwright measured Library button center around x=54 y=350 inside the app viewport.
# Add a small top offset for the native window frame.
$clickX = $rect.Left + 54
$clickY = $rect.Top + 382
...
$out = 'C:\Users\likwi\OneDrive\Desktop\PROJS\SimSort\docs\agent-reports\phase3-windows-library.png'
